...
export default function Browse() {
  ...
  return (
    <PublicLayout>
      <div className="min-h-screen py-24 px-6 bg-gradient-to-br from-slate-50 via-white to-purple-50/30 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            {browseFeatures.map((feature, index) => (
              ...
              >
                <div className="absolute -top-10 -right-10 w-40 h-40 bg-gradient-to-br from-purple-400/20 to-transparent rounded-full blur-3xl group-hover:opacity-70 opacity-40 transition-opacity duration-500" />
                
                <div className="relative">
                  <motion.div 
                    className={`size-14 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-5 shadow-2xl shadow-purple-500/40`}
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {viewModes.map((mode, index) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-50/50 via-transparent to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500" />
                  
                  <div className="relative">
                    <motion.div 
                      className="size-16 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-xl shadow-purple-200/50"
                    ...
                    >
                      <mode.icon className="size-8 text-purple-600" />
                    </motion.div>
          ...
          >
            <div className="relative bg-gradient-to-br from-purple-50/80 to-violet-50/80 backdrop-blur-xl rounded-3xl p-12 md:p-16 text-center overflow-hidden border border-purple-100/50"
              style={{
                boxShadow: '0 25px 70px -20px rgba(147, 51, 234, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.5) inset'
              }}
            >
              <div className="absolute -top-20 -right-20 w-60 h-60 bg-gradient-to-br from-purple-300/30 to-transparent rounded-full blur-3xl" />
              <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-gradient-to-br from-violet-300/30 to-transparent rounded-full blur-3xl" />
              
              <div className="relative">
                <motion.div
                  className="inline-flex p-6 bg-white/80 backdrop-blur-sm rounded-3xl mb-6 shadow-xl shadow-purple-200/50"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{ delay: 1.8, type: 'spring', stiffness: 200 }}
                  style={{
                    boxShadow: '0 15px 40px -10px rgba(147, 51, 234, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.5) inset'
                  }}
                >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-violet-600 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
                  <div className="relative px-10 py-5 bg-gradient-to-r from-purple-600 to-violet-600 text-white font-semibold rounded-2xl flex items-center gap-3 shadow-2xl shadow-purple-500/40"
                    style={{
                      boxShadow: '0 15px 40px -10px rgba(147, 51, 234, 0.5)'
                    }}
                  >
