      ...
      >
        <div className="relative bg-white rounded-3xl shadow-2xl p-10 text-center overflow-hidden">
          ...
          <div className="relative">
            <motion.div
              className="size-24 bg-gradient-to-br from-red-500 to-purple-600 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg"
            ...
            <div className="flex flex-col gap-3">
              <motion.button
                ...
                className="w-full py-3 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all flex items-center justify-center gap-2"
