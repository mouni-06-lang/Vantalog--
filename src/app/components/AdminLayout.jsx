...
import { GraduationCap, LayoutDashboard, Upload, FolderOpen, Users, MessageSquare, LogOut, Menu, X, UserCircle, ArrowLeft, Home } from 'lucide-react';
...
export default function AdminLayout({ children }) {
  ...
  const { logout, getUrlSafeName, getUrlSafeEmail, user } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <ResizablePanelGroup direction="horizontal" className="min-h-screen">
        ...
        {/* Resize Handle */}
        <ResizableHandle withHandle className="hover:bg-purple-500/20 transition-colors" />
